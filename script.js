...
class CineAlgo {
    ...
    initChatbot() {
        ...
        // Gemini API
        this.GEMINI_API_KEY = 'AIzaSyCap3PclWfDZZq3GedGk_te0tvs6QqTh0o';
        this.GEMINI_API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=${this.GEMINI_API_KEY}`;
        ...
        card.innerHTML = `
            ...
            <div class="movie-info">
                ...
                <div class="movie-actions">
                    <button class="action-btn primary" onclick="window.cineGenius.showMovieDetails('${movie.id}')">
                        <span>📱</span> Details
                    </button>
                    <button class="action-btn secondary" onclick="window.cineGenius.addToWatchlist('${movie.id}')">
                        <span>➕</span> Watchlist
                    </button>
                    <button class="action-btn tertiary" onclick="window.cineGenius.shareMovie('${movie.id}', '${movie.title.replace(/'/g, "\\'")}')">
                        <span>📤</span> Share
                    </button>
                </div>
            </div>
    ...
    showError(message) {
        ...
        this.resultsGrid.innerHTML = `
            <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px;">
                ...
                <button onclick="window.cineGenius.searchInput.focus()" 
